...
export interface IRegistration extends Document {
    ...
    paymentStatus: "initiated" | "pending" | "paid" | "failed" | "refunded" | "manual_verified" | "manual_verification_pending";
    razorpayOrderId?: string;
...
const RegistrationSchema = new Schema<IRegistration>(
    {
        ...
        paymentStatus: {
            type: String,
            enum: ["initiated", "pending", "paid", "failed", "refunded", "manual_verified", "manual_verification_pending"],
            default: "initiated",
        },
